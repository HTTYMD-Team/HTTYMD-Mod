...
public class ModelDeadlyNadder extends ModelDragon {
	...
	public ModelDeadlyNadder() {
		...
		this.setRotation(this.leftclaw1, 0.0F, 0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.rightclaw1, 0.0F, 0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.horn1, -0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotation(this.neck1, -0.5235987901687622F, -0.0F, 0.0F);
		...
		this.setRotation(this.tail4, -0.08726646006107329F, -0.0F, 0.0F);
		...
		this.setRotation(this.neck2, -0.5235987901687622F, -0.0F, 0.0F);
		...
		this.setRotation(this.leftclaw5, -0.43633231520652765F, -0.0F, 0.0F);
		...
		this.setRotation(this.cresthorn3, 0.43633231520652765F, 0.08726646006107329F, 0.0F);
		...
		this.setRotation(this.liftbicep, 0.0F, -0.5235987901687622F, 0.0F);
		...
		this.setRotation(this.leftclaw3, 0.0F, 0.08726646006107329F, 0.0F);
		...
		this.setRotation(this.cresthorn10, -0.22689279913902283F, -0.6981316804885863F, 0.0F);
		...
		this.setRotation(this.cresthorn4, 0.08726646006107329F, 0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.neck3, -0.6108652353286743F, -0.0F, 0.0F);
		...
		this.setRotation(this.horn2, -0.6108652353286743F, -0.0F, 0.0F);
		...
		this.setRotation(this.rightforearm, 0.0F, -0.6981316804885863F, 0.0F);
		...
		this.setRotation(this.cresthorn5, 0.08726646006107329F, -0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.cresthorn7, 0.0F, 0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.rightclaw2, 0.0F, -0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.leftforearm, 0.0F, 0.6981316804885863F, 0.0F);
		...
		this.setRotation(this.cresthorn8, -0.08726646006107329F, -0.6108652353286743F, 0.0F);
		...
		this.setRotation(this.cresthorn6, 0.0F, -0.43633231520652765F, 0.0F);
		...
		this.setRotation(this.stomach, -0.17453292012214658F, -0.0F, 0.0F);
		...
		this.setRotation(this.cresthorn9, -0.08726646006107329F, 0.6108652353286743F, 0.0F);
		...
		this.setRotation(LeftLeg2, -0.08726646006107329F, -0.0F, -0.08726646006107329F);
		...
		this.setRotation(RightLeg2, -0.08726646006107329F, -0.0F, 0.08726646006107329F);
		...
		this.setRotation(this.spike3, -0.17453292012214658F, -0.0F, 0.0F);
		...
		this.setRotation(this.leftclaw4, 0.0F, -0.08726646006107329F, 0.0F);
		...
		this.setRotation(this.cresthorn11, -0.22689279913902283F, 0.6981316804885863F, 0.0F);
		...
		this.setRotation(this.upperbody, -0.43633231520652765F, -0.0F, 0.0F);
		...
		this.setRotation(this.rightclaw3, 0.0F, 0.08726646006107329F, 0.0F);
		...
		this.setRotation(this.rightbicep, 0.0F, 0.5235987901687622F, 0.0F);
		...
		this.setRotation(Head, 0.08726646006107329F, -0.0F, 0.0F);
		...
		this.setRotation(this.rightclaw4, 0.0F, -0.08726646006107329F, 0.0F);
		...
		this.setRotation(this.leftclaw2, 0.0F, -0.34906584024429316F, 0.0F);
		...
		this.setRotation(this.cresthorn1, 0.5235987901687622F, -0.0F, 0.0F);
		...
		this.setRotation(this.spike4, -0.17453292012214658F, -0.0F, 0.0F);
		...
		this.setRotation(this.spike2, -0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotation(this.tail2, -0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotation(this.horn4, -1.0471975803375244F, -0.0F, 0.0F);
		...
		this.setRotation(this.cresthorn2, 0.43633231520652765F, -0.08726646006107329F, 0.0F);
		...
		this.setRotation(this.horn3, -0.8726646304130553F, -0.0F, 0.0F);
		...
		this.setRotation(this.rightclaw5, -0.43633231520652765F, -0.0F, 0.0F);
		...
		this.setRotation(this.spike1, -0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotation(this.tail1, -0.34906584024429316F, -0.0F, 0.0F);
		...
		this.setRotation(this.spike5, -0.2617993950843811F, -0.0F, 0.0F);
		...
		this.setRotation(this.tail3, -0.17453292012214658F, -0.0F, 0.0F);
		...
		this.setRotation(this.spike6, -0.2617993950843811F, -0.0F, 0.0F);
	}
}
