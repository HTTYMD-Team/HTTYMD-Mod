...
public class ModelSkrill extends ModelDragon {
	...
	public ModelSkrill() {
		...
		this.setRotation(LeftLeg1, -0.3141593F, 0F, -0.1745329F);
		...
		this.setRotation(LeftLeg2, 0F, 0F, 0F);
		...
		this.setRotation(LeftClaw1, 0F, -0.2617994F, 0F);
		...
		this.setRotation(LeftClaw2, -0.2617994F, 0F, 0F);
		...
		this.setRotation(LeftClaw3, 0F, 0.2617994F, 0F);
		...
		this.setRotation(LeftClaw4, 0.2617994F, 0F, 0F);
		...
		this.setRotation(RightLeg1, -0.3141593F, 0F, 0.1745329F);
		...
		this.setRotation(RightLeg2, 0F, 0F, 0F);
		...
		this.setRotation(RightClaw1, 0F, 0.2617994F, 0F);
		...
		this.setRotation(RightClaw2, -0.2617994F, 0F, 0F);
		...
		this.setRotation(RightClaw3, 0F, -0.2617994F, 0F);
		...
		this.setRotation(RightClaw4, 0.2617994F, 0F, 0F);
		...
		this.setRotation(UpperHead, 0.1745329F, 0.7766715F, 0.1745329F);
		...
		Jaw.mirror = true;
		this.setRotation(Jaw, 0.0698132F, 0.7906342F, 0.0523599F);
		...
		this.setRotation(ChinSpike1, -0.4363323F, 0F, 0F);
		...
		this.setRotation(ChinSpike2, -0.4363323F, 0F, 0F);
		...
		this.setRotation(NoseHorn, -0.2617994F, -0.7853982F, 0.2617994F);
		...
		this.setRotation(CrestHorn1, 0.7853982F, 0F, 0F);
		...
		this.setRotation(CrestHorn2, 0.6981317F, -0.2443461F, 0F);
		...
		this.setRotation(CrestHorn3, 0.6981317F, 0.2443461F, 0F);
		...
		this.setRotation(CrestHorn4, 0.6981317F, -0.3490659F, 0F);
		...
		this.setRotation(CrestHorn5, 0.6981317F, 0.3490659F, 0F);
		...
		this.setRotation(CrestHorn6, 0.6981317F, -0.5235988F, 0F);
		...
		this.setRotation(CrestHorn7, 0.6981317F, 0.5235988F, 0F);
		...
		this.setRotation(CrestHorn8, 0.6981317F, -0.6981317F, 0F);
		...
		this.setRotation(CrestHorn9, 0.6981317F, 0.6981317F, 0F);
		...
		this.setRotation(CrestHorn10, 0.6283185F, -0.7853982F, -0.1047198F);
		...
		this.setRotation(CrestHorn11, 0.6283185F, 0.7853982F, 0.1047198F);
		...
		this.setRotation(CrestHorn12, 0.6283185F, -0.9948377F, -0.2617994F);
		...
		this.setRotation(CrestHorn13, 0.6283185F, 0.9948377F, 0.2617994F);
		...
		this.setRotation(CrestHorn14, 0.3490659F, -1.570796F, 0F);
		...
		this.setRotation(CrestHorn15, 0.3490659F, 1.570796F, 0F);
		...
		this.setRotation(CrestHorn16, 0F, 1.570796F, 0F);
		...
		this.setRotation(CrestHorn17, 0F, 1.570796F, 0F);
		...
		this.setRotation(CrestHorn18, 0F, -0.0872665F, 0.1047198F);
		...
		this.setRotation(CrestHorn19, 0F, -2.879793F, 0.1047198F);
		...
		this.setRotation(CrestHorn20, -0.5235988F, 1.22173F, 0F);
		...
		this.setRotation(CrestHorn21, -0.5235988F, -1.22173F, 0F);
		...
		this.setRotation(CrestHorn22, -1.047198F, 0F, -0.3490659F);
		...
		this.setRotation(CrestHorn23, -1.047198F, 0F, 0.3490659F);
		...
		this.setRotation(CrestHorn24, -1.047198F, 0F, 0F);
		...
		this.setRotation(CrestHorn25, -1.047198F, 0F, 0F);
		...
		this.setRotation(CrestHorn26, -0.8726646F, 0F, 0F);

		this.head = new ModelRenderer(this);
		this.head.setRotationPoint(0F, -7F, -10F);
		this.head.addChild(UpperHead);
		this.head.addChild(Jaw);
		this.head.addChild(ChinSpike1);
		this.head.addChild(ChinSpike2);
		this.head.addChild(NoseHorn);
		this.head.addChild(CrestHorn1);
		this.head.addChild(CrestHorn2);
		this.head.addChild(CrestHorn3);
		this.head.addChild(CrestHorn4);
		this.head.addChild(CrestHorn5);
		this.head.addChild(CrestHorn6);
		this.head.addChild(CrestHorn7);
		this.head.addChild(CrestHorn8);
		this.head.addChild(CrestHorn9);
		this.head.addChild(CrestHorn10);
		this.head.addChild(CrestHorn11);
		this.head.addChild(CrestHorn12);
		this.head.addChild(CrestHorn13);
		this.head.addChild(CrestHorn14);
		this.head.addChild(CrestHorn15);
		this.head.addChild(CrestHorn16);
		this.head.addChild(CrestHorn17);
		this.head.addChild(CrestHorn18);
		this.head.addChild(CrestHorn19);
		this.head.addChild(CrestHorn20);
		this.head.addChild(CrestHorn21);
		this.head.addChild(CrestHorn22);
		this.head.addChild(CrestHorn23);
		this.head.addChild(CrestHorn24);
		this.head.addChild(CrestHorn25);
		this.head.addChild(CrestHorn26);
		...
		Neck.mirror = true;
		this.setRotation(Neck, -0.3839724F, 0F, 0F);
		...
		this.setRotation(BodyFront, 0.0872665F, 0F, 0F);
		...
		this.setRotation(BodyBack, -0.0872665F, 0F, 0F);
		...
		Tail2.mirror = true;
		this.setRotation(Tail2, -0.2268928F, 0F, 0F);
		...
		Tail4.mirror = true;
		this.setRotation(Tail4, -0.3141593F, 0F, 0F);
		...
		Tail5.mirror = true;
		this.setRotation(Tail5, -0.2268928F, 0F, 0F);
		...
		Tail6.mirror = true;
		this.setRotation(Tail6, -0.1570796F, 0F, 0F);
		...
		Tail7.mirror = true;
		this.setRotation(Tail7, -0.1047198F, 0F, 0F);
		...
		Tail8.mirror = true;
		this.setRotation(Tail8, -0.0349066F, 0F, 0F);
		...
		Spike1.mirror = true;
		this.setRotation(Spike1, -0.4363323F, 0F, 0F);
		...
		Spike2.mirror = true;
		this.setRotation(Spike2, -0.3490659F, 0F, 0F);
		...
		Spike3.mirror = true;
		this.setRotation(Spike3, -0.3490659F, 0F, 0F);
		...
		Spike4.mirror = true;
		this.setRotation(Spike4, -0.4363323F, 0F, 0F);
		...
		Spike5.mirror = true;
		this.setRotation(Spike5, -0.5235988F, 0F, 0F);
		...
		Spike6.mirror = true;
		this.setRotation(Spike6, -0.5235988F, 0F, 0F);
		...
		Spike7.mirror = true;
		this.setRotation(Spike7, -0.5585054F, 0F, 0F);
		...
		Spike8.mirror = true;
		this.setRotation(Spike8, -0.6108652F, 0F, 0F);
		...
		Spike9.mirror = true;
		this.setRotation(Spike9, -0.6981317F, 0F, 0F);
		...
		Spike10.mirror = true;
		this.setRotation(Spike10, -0.7853982F, 0F, 0F);
		...
		Spike11.mirror = true;
		this.setRotation(Spike11, -0.8726646F, 0F, 0F);
		...
		Spike12.mirror = true;
		this.setRotation(Spike12, -0.9599311F, 0F, 0F);
		...
		Spike13.mirror = true;
		this.setRotation(Spike13, -1.047198F, 0F, 0F);
		...
		Spike14.mirror = true;
		this.setRotation(Spike14, -1.047198F, 0F, 0F);
		...
		Spike15.mirror = true;
		this.setRotation(Spike15, -1.047198F, 0F, 0F);
		...
		Spike16.mirror = true;
		this.setRotation(Spike16, -0.9599311F, 0F, 0F);
		...
		Spike17.mirror = true;
		this.setRotation(Spike17, -0.9075712F, 0F, 0F);
		...
		Spike18.mirror = true;
		this.setRotation(Spike18, -0.9075712F, 0F, 0F);
		...
		Spike19.mirror = true;
		this.setRotation(Spike19, -0.7679449F, 0F, 0F);
		...
		Spike20.mirror = true;
		this.setRotation(Spike20, -0.7853982F, 0F, 0F);
		...
		Spike21.mirror = true;
		this.setRotation(Spike21, -0.6981317F, 0F, 0F);
		...
		Spike22.mirror = true;
		this.setRotation(Spike22, -0.6981317F, 0F, 0F);
		...
		Spike23.mirror = true;
		this.setRotation(Spike23, -0.7853982F, 0F, 0F);

		this.body = new ModelRenderer(this);
		this.body.setRotationPoint(0F, 0, 0);
		this.body.addChild(Neck);
		this.body.addChild(BodyFront);
		this.body.addChild(BodyMiddle);
		this.body.addChild(BodyBack);
		this.body.addChild(Tail1);
		this.body.addChild(Tail2);
		this.body.addChild(Tail3);
		this.body.addChild(Tail4);
		this.body.addChild(Tail5);
		this.body.addChild(Tail6);
		this.body.addChild(Tail7);
		this.body.addChild(Tail8);
		this.body.addChild(Tail9);
		this.body.addChild(Tail10);
		...
		this.setRotation(LeftArm1, 0F, 0.1745329F, 0F);
		...
		this.setRotation(LeftArm2, 0F, 0.5235988F, 0F);
		...
		this.setRotation(LeftArm3, 0F, -0.0872665F, 0F);
		...
		this.setRotation(LeftArm4, 0F, -0.3490659F, 0F);
		...
		this.setRotation(LeftWing1, 0F, 0F, 0F);
		...
		this.setRotation(LeftWing2, 0F, 0F, 0F);
		...
		this.setRotation(LeftSpine1, 0F, -0.5585054F, 0F);
		...
		this.setRotation(LeftSpine2, 0F, -0.9250245F, 0F);
		...
		this.setRotation(LeftSpine3, 0F, -1.343904F, 0F);
		...
		this.setRotation(LeftSpine4, 0F, -1.745329F, 0F);
		...
		this.setRotation(LeftWingClaw1, 0F, 0F, 0F);
		...
		this.setRotation(LeftWingClaw2, 0F, -0.2617994F, 0F);
		...
		this.setRotation(LeftWingClaw3, 0F, -0.5759587F, 0F);

		this.wing = new ModelRenderer(this);
		this.wing.setRotationPoint(8F, -8F, 3F);
		this.wing.addChild(LeftArm1);
		this.wing.addChild(LeftArm2);
		this.wing.addChild(LeftArm3);
		this.wing.addChild(LeftArm4);
		this.wing.addChild(LeftWing1);
		this.wing.addChild(LeftWing2);
		this.wing.addChild(LeftSpine1);
		this.wing.addChild(LeftSpine2);
		this.wing.addChild(LeftSpine3);
		this.wing.addChild(LeftSpine4);
		this.wing.addChild(LeftWingClaw1);
		this.wing.addChild(LeftWingClaw2);
		this.wing.addChild(LeftWingClaw3);
