...
public class EventRegistry {
	...
	public static ArrayList<IDrop> getDropsFor(EntityLivingBase entity) {
		...
		for(IDrop d : drops) {
			if(d.isForEntity(entity)) dropList.add(d);
		}
		
		return dropList;
	}
	
	public static ArrayList<ItemStack> handleDropStacks(EntityLivingBase entity, DamageSource source, int lootLevel, boolean recentHit, int value) {
