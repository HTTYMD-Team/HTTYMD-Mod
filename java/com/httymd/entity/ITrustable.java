...
public interface ITrustable {
	...
	/**
	 * Retrieves the level of trust from this entity for specific entities, some actions are able to
	 * increase this while others decrease it, determines how it reacts to you
