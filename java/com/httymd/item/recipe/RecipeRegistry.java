...
public class RecipeRegistry {
	...
	public static void init() {
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.daggerWood),
				"#", "|", '|', Items.stick, '#', Blocks.planks);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.daggerStone),
				"#", "|", '|', Items.stick, '#', Blocks.cobblestone);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.daggerIron),
				"#", "|", '|', Items.stick, '#', Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.daggerGold),
				"#", "|", '|', Items.stick, '#', Items.gold_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.daggerDiam),
				"#", "|", '|', Items.stick, '#', Items.diamond);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.daggerGron),
				"#", "|", '|', Items.stick, '#', ItemRegistry.gronkleIronIngot);

		GameRegistry.addRecipe(new ItemStack(ItemRegistry.clubWood),
				"#|#", " | ", " | ", '|', Items.stick, '#', Blocks.planks);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.clubStone),
				"#|#", " | ", " | ", '|', Items.stick, '#', Blocks.cobblestone);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.clubIron),
				"#|#", " | ", " | ", '|', Items.stick, '#', Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.clubGold),
				"#|#", " | ", " | ", '|', Items.stick, '#', Items.gold_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.clubDiam),
				"#|#", " | ", " | ", '|', Items.stick, '#', Items.diamond);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.clubGron),
				"#|#", " | ", " | ", '|', Items.stick, '#', ItemRegistry.gronkleIronIngot);

		GameRegistry.addRecipe(new ItemStack(ItemRegistry.maceWood),
				" # ", "#|#", " | ", '|', Items.stick, '#', Blocks.planks);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.maceStone),
				" # ", "#|#", " | ", '|', Items.stick, '#', Blocks.cobblestone);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.maceIron),
				" # ", "#|#", " | ", '|', Items.stick, '#', Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.maceGold),
				" # ", "#|#", " | ", '|', Items.stick, '#', Items.gold_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.maceDiam),
				" # ", "#|#", " | ", '|', Items.stick, '#', Items.diamond);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.maceGron),
				" # ", "#|#", " | ", '|', Items.stick, '#', ItemRegistry.gronkleIronIngot);

		GameRegistry.addRecipe(new ItemStack(ItemRegistry.hammerWood),
				"###", "#|#", " | ", '|', Items.stick, '#', Blocks.planks);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.hammerStone),
				"###", "#|#", " | ", '|', Items.stick, '#', Blocks.cobblestone);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.hammerIron),
				"###", "#|#", " | ", '|', Items.stick, '#', Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.hammerGold),
				"###", "#|#", " | ", '|', Items.stick, '#', Items.gold_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.hammerDiam),
				"###", "#|#", " | ", '|', Items.stick, '#', Items.diamond);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.hammerGron),
				"###", "#|#", " | ", '|', Items.stick, '#', ItemRegistry.gronkleIronIngot);

		GameRegistry.addRecipe(new ItemStack(ItemRegistry.waraxeWood),
				"#|#", "#|#", " | ", '|', Items.stick, '#', Blocks.planks);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.waraxeStone),
				"#|#", "#|#", " | ", '|', Items.stick, '#', Blocks.cobblestone);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.waraxeIron),
				"#|#", "#|#", " | ", '|', Items.stick, '#', Items.iron_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.waraxeGold),
				"#|#", "#|#", " | ", '|', Items.stick, '#', Items.gold_ingot);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.waraxeDiam),
				"#|#", "#|#", " | ", '|', Items.stick, '#', Items.diamond);
		GameRegistry.addRecipe(new ItemStack(ItemRegistry.waraxeGron),
				"#|#", "#|#", " | ", '|', Items.stick, '#', ItemRegistry.gronkleIronIngot);
